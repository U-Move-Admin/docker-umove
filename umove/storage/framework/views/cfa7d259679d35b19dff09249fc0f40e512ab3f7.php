                ...
                <nav class="navbar navbar-expand-lg navbar-light rounded">
                    ...
                    <div class="navbar-collapse collapse w-100" id="navbar">
                        <ul class="navbar-nav w-100">
                            ...
                            <li class="nav-item dropdown <?php echo e($active_header == 'umovecollections-listing' ? 'active' : ''); ?>">
                                <a class="nav-link" href="<?php echo e(url('listing/umovecollections')); ?>" >U Move Collections</a>
                            </li>
                            <li class="nav-item dropdown <?php echo e($active_header == 'studentfriendly-listing' ? 'active' : ''); ?>">
                                <a class="nav-link" href="<?php echo e(url('listing/student')); ?>" >Student Friendly Accomodations</a>
                            </li>
...
</style><?php /**PATH /var/www/html/resources/views/frontend/template1/elements/top_menu.blade.php ENDPATH**/ ?>