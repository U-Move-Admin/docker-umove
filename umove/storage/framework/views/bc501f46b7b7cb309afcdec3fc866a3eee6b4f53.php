...
<?php endif; ?>
            ...
            <a class="underline text-sm text-gray-600 hover:text-gray-900 mr-1" href="<?php echo e(route('register')); ?>">
                        <?php echo e(__('Register')); ?>

                    </a>
                    or
                <?php if(Route::has('password.request')): ?>
                    <a class="underline text-sm text-gray-600 hover:text-gray-900 ml-1" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH /homepages/1/d814676099/htdocs/umove.london/resources/views/auth/login.blade.php ENDPATH**/ ?>