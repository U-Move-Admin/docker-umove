...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <link href="<?php echo e(asset('assets/demo/default/base/style.bundle.min.css')); ?>" rel="stylesheet" type="text/css" />

        <!--end::Global Theme Styles -->

        <!--begin::Layout Skins(used by all pages) -->
        <link href="<?php echo e(asset('assets/demo/default/skins/header/base/light.min.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('assets/demo/default/skins/header/menu/light.min.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('assets/demo/default/skins/brand/dark.min.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('assets/demo/default/skins/aside/dark.min.css')); ?>" rel="stylesheet" type="text/css" />
...
<?php /**PATH /homepages/0/d872858855/htdocs/umove/resources/views/layouts/admin.blade.php ENDPATH**/ ?>