...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> <?php echo e(__('Add Property')); ?>  <?php $__env->endSlot(); ?>
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                ...
                <div class="kt-portlet__body">
                    <?php echo Form::open(array('route' => 'properties.store','method'=>'POST', 'id' => 'property_form', 'enctype'=>'multipart/form-data')); ?>    
                        <input type="hidden" name="image_new_sort" id="image_new_sort">
                        <input type="hidden" name="property_status" value="<?php echo e($property_status); ?>">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="kt-radio-inline">
                                                    ...
                                                    <label class="kt-radio">
                                                        <input type="radio" name="advert_type" value="<?php echo e($i); ?>" onclick="handleAdvertType('<?php echo e($i); ?>')"> <?php echo e($item); ?>
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-12 col-md-6">
                                                <div class="row">
                                                    <div class="col-sm-6 kt-font-bolder"><?php echo e($item); ?>

                                                        <label data-toggle="kt-tooltip" title="Show On Public">
                                                            <input type="checkbox" checked="" name="view_<?php echo e($i); ?>">
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                            <label>
                                                                <input type="checkbox" name="<?php echo e($i); ?>" >
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
...
<?php /**PATH /home/u390945238/domains/umove.london/resources/views/admin/properties/add.blade.php ENDPATH**/ ?>