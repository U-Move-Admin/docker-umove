$(function () {
    ...
    $(window).on('load', function () {
        ...
        setTimeout(function () {
            ...
            $('link[id="style_sheet"]').attr('href', '/frontend/templates/css/default.css');
        }, 1000);
        ...
        if(windowWidth > 0) {
            if ($(document).scrollTop() >= 40) {
                ...
                if($('.do-sticky').length < 1) {
                    $('.logo img').attr('src', '/img/logo-3.png');
                }
            }
            else {
    ...
    $(".range-slider-ui").each(function () {
        ...
        $(this).slider({
            ...
            slide: function (event, ui) {
                ...
                $(this).children(".min-value").html( currentMin + " " + unit);
                $(this).children(".max-value").html(currentMax + " " + unit);
      ...
      var validation = Array.prototype.filter.call(forms, function(form) {
        form.addEventListener('submit', function(event) {
          if (form.checkValidity() === false) {
            ...
            if(response.length == 0 && forms[0].getAttribute('id') === 'contact') 
            { 
            ...
            $(' .btn',this).html('<i class="fa fa-spin fa-spinner"></i> Sending...');
          }
...
(function ($) {
    ...
    var $meterSlider = $("#meter-reinput");
    if($meterSlider.length > 0) {
        $meterSlider.slider({
            from: 1,
            to: 1000,
            step: 10,
            //round: 1,
            format: { format: '###,###', locale: 'gpb' },
    ...
    //$('.currency-tl').turkLirasi({autoFillDecimal:false});
})(jQuery);
