...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($role->syncPermissions($request->input('permission'))){
            ActivityLogger::activity("The role created. Name: ".$role['name']);
    ...
    public function update(Request $request, $id)
    {
        ...
        if($role->syncPermissions($request->input('permission'))){
            ActivityLogger::activity("The role updated. Name: ".$role['name']);
            Session::flash('title','Good Job!');
    ...
    public function destroy($id)
    {
        ...
        if(DB::table("roles")->where('id',$id)->delete()){
            ActivityLogger::activity("The role deleted. Name: ".$role['name']);
            Session::flash('title','Good Job!');
