...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{ asset('assets/demo/default/skins/brand/dark.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<script src="{{ asset('js/admin/autoNumeric-min.js') }}" type="text/javascript"></script>
		...
		<script type="text/javascript">
            ...
            @if (session('message'))
				...
				showDialog("{{ session('title') }}","{{ session('message') }}","{{session('type')}}","btn-'.(session('type') == 'error' ? 'danger': session('type') )}}");
            @endif
        </script>
