...
<html lang="en">
    ...
    <head>
        ...
        <link rel="mask-icon" href="{{asset('/safari-pinned-tab.svg')}}" color="#042a80">
        ...
        <!-- Custom Stylesheet -->
        <link type="text/css" rel="stylesheet" href="{{ asset('/frontend/templates/css/style.css') }}">
                    ...
                    <div class="col-lg-12">
                        <div class="pages-404-inner">
                            ...
                            <div class="e404">
                                ...
                                <a class="btn btn-border btn-sm" href="{{ asset('/') }}" role="button">Back Home Page</a>
                            </div>
                        </div>
                    </div>
                </div>
