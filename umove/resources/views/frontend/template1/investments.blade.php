...
@section('title','Invesments | '.config('app.name'))
@section('meta')
    <meta name="description" content="{{ 'Invesments '.config('app.name') }}"/>
    <!-- facebook --> 
    <meta property="og:type" content="article">
    <meta property="og:url" content="{{ url()->current() }}" />
    <meta property="og:title" content="{{ 'Invesments '.config('app.name') }}" />
    <meta property="og:image" content="{{ asset(config('broker.logo')) }}">
    <meta property="og:description" content="{{ 'Invesments '.config('app.name') }}">  
    <!-- twitter -->
    <meta name="twitter:title" content="{{ 'Invesments '.config('app.name') }}">  
    <meta name="twitter:description" content="{{ 'Invesments '.config('app.name') }}">  
    <meta name="twitter:image:src" content="{{ asset(config('broker.logo')) }}">  
    <!-- google -->
    <meta itemprop="name" content="{{ 'Invesments '.config('app.name') }}">  
    <meta itemprop="description" content="{{ 'Invesments '.config('app.name') }}">  
                ...
                <div class="swiper-slide">
                    <div>
                        <div class="row light">
                            ...
                            <div class="col-md-6">
                                <img src="{{ asset('/img/image_1.jpg') }}" alt="image slider 1" >
                            </div>
                        </div>
                ...
                <div class="swiper-slide">
                    <div>
                        <div class="row light">
                            ...
                            <div class="col-md-6">
                                <img src="{{ asset('/img/image_2.jpg') }}" alt="image slider 2" >
                            </div>
                        </div>
                        <div class="section section-about">
                            <div class="container-fluid">
                ...
                <div class="swiper-slide">
                    <div>
                        <div class="row light">
                            ...
                            <div class="col-md-6">
                                <img src="{{ asset('/img/image_3.jpg') }}" alt="image slider 3" >
                            </div>
                        </div>
                        <div class="section section-about">
                            <div class="container-fluid">
