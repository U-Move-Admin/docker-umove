<x-admin-layout>
    <x-slot name="header">{{ __('Store Details') }} </x-slot>
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                ...
                <div class="kt-portlet__body">
                    {!! Form::model($store, ['method' => 'POST','route' => ['store_details'], 'class'=> 'kt-form', 'id'=>'kt_form_1', 'enctype'=>"multipart/form-data" ]) !!}
                                ...
                                <div class="kt-section kt-section--first">
                                    ...
                                    <div class="kt-section__body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                {!! Form::text('store_name', null, array('placeholder' => '','class' => 'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-3 col-form-label">Legal name of Company</label>
                                            <div class="col-9">
                                                {!! Form::text('legal_name', null, array('placeholder' => '','class' => 'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group row">
											...
											<div class="col-9">
                                                ...
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    ...
                                                    <img width="120" src="{{ asset($logo) }}" > <div>
                                                        <span class="btn btn-outline-brand btn-file">
                                                            <span class="fileinput-new"> Select Image </span>
                                                            <span class="fileinput-exists"> Change </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                {!! Form::text('about_company_title', null, array('placeholder' => 'Title','class' => 'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-3 col-form-label">*About Company </label>
                                            <div class="col-9">
                                                {!! Form::textarea('about_company', null, array('placeholder' => 'A Brief History of the Company','class' => 'form-control')) !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            {!! Form::text('address', null, array('placeholder' => 'Address','class' => 'form-control', 'onchange' => 'setAddress()')) !!}
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-3 col-form-label">*Postcode</label>
                                        <div class="col-9">
                                            {!! Form::text('postcode', null, array('placeholder' => 'Postcode','class' => 'form-control', 'onchange' => 'setAddress()')) !!}
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-3 col-form-label">*City</label>
                                        <div class="col-9">
                                            {!! Form::text('city', null, array('placeholder' => 'City','class' => 'form-control', 'onchange' => 'setAddress()')) !!}
                                        </div>
                                    </div>
                                    <div class="form-group row">
    ...
    <script src="{{ asset('js/admin/store_details.js') }}" type="text/javascript"></script>
