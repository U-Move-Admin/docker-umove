<x-admin-layout>
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">Edit {{ Str::ucfirst($property->property_status) }} Property <small>try to scroll the page</small></h3>
                    </div>
                ...
                <div class="kt-portlet__body">
                    {!! Form::model($property, ['method' => 'PATCH','route' => ['properties.update', $property->id], 'class'=> 'kt-form', 'id'=>'property_form', 'enctype'=>'multipart/form-data']) !!}
                        <input type="hidden" name="image_new_sort" id="image_new_sort">
                        <input type="hidden" name="property_status" value="{{ $property->property_status }}">
                            ...
                            <div class="col-xl-12">
                                        ...
                                        <div class="form-group row">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input name="view_postcode" type="checkbox" {{ $view_property->view_postcode ? 'checked=""' : ''}} >
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="kt-radio-inline">
                                                    ...
                                                    @foreach(config('home.advert_type') as $i => $item)
                                                    <label class="kt-radio">
                                                        <input type="radio" name="advert_type" {{ $property->advert_type === $i ? 'checked': ''  }} value="{{$i}}" onclick="handleAdvertType('{{$i}}')"> {{$item}}
                                                        <span></span>
                                                    </label>
                                                    @endforeach
                                                    @else
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" {{ $view_property->view_address ? 'checked=""' : ''}} name="view_address">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    {!! Form::text('address', null, array('class' => 'form-control', 'placeholder'=>"Flat 301 or 10 Downing St")) !!}
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" {{ $view_property->view_property_type ? 'checked=""' : ''}} name="view_property_type">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" {{ $view_property->view_address2 ? 'checked=""' : ''}} name="view_address2">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    {!! Form::text('address2', null, array('class' => 'form-control', 'placeholder'=>"eg. 10 Downing St or Westminster")) !!}
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group row">
                                                    <div class="col-6">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text">
                                                                    <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                        <input type="checkbox" {{ $view_property->view_bedroom ? 'checked=""' : ''}} name="view_bedroom">
                                                                        <span></span>
                                                                    </label>
                                                                </span>
                                                            </div>
                                                            {!! Form::text('bedroom', null, array('class' => 'form-control bedroom')) !!}
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text">
                                                                    <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                        <input type="checkbox" {{ $view_property->view_bathroom ? 'checked' : ''}} name="view_bathroom">
                                                                        <span></span>
                                                                    </label>
                                                                </span>
                                                            </div>
                                                            {!! Form::text('bathroom', null, array('class' => 'form-control bathroom')) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" {{ $view_property->view_address3 ? 'checked' : ''}} name="view_address3">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" {{ $view_property->view_furnished ? 'checked=""' : ''}} name="view_furnished">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    <select class="form-control" id="Furnished" name="furnished" data-val-number="The field Furnishing Options must be a number." data-val-required="Does the property come furnished?" >
                                                        <option value="">Please Select -&gt;</option>
                                                        @foreach(config('home.furnished') as $i => $item)
                                                        <option value="{{$i}}"{{ $property->furnished === $i ? 'selected="selected"' : ''}} >{{ $item }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" {{ $view_property->view_city ? 'checked=""' : ''}} name="view_city">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    {!! Form::text('city', null, array('class' => 'form-control', ' placeholder' => 'eg. London')) !!}
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" {{ $view_property->view_location ? 'checked=""' : ''}} name="view_location">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    {!! Form::text('location', !empty($property->lng) ? 'The location marked' : null, array('class' => 'form-control', 'readonly'=> true, 'placeholder' => 'Please choose location of the property on Map')) !!}
                                                    {!! Form::hidden('lng', null, array()) !!}
                                                    {!! Form::hidden('lat', null, array()) !!}
                                                    {!! Form::hidden('zoom', null, array()) !!}
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" {{ $view_property->view_price ? 'checked=""' : ''}} name="view_price">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                        <span class="input-group-text">£</span>
                                                    </div>
                                                    {!! Form::text('price', null, array('class' => 'form-control price', ' placeholder' => '0.00')) !!}
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info">
                                                                <input type="checkbox" {{ $view_property->view_min_tenancy_length ? 'checked=""' : ''}}  name="view_min_tenancy_length" data-toggle="kt-tooltip" title="Show On Public">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                        
                                                    </div>
                                                    {!! Form::text('min_tenancy_length', null, array('class' => 'form-control tenancy-month', ' placeholder' => '0.00')) !!}
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" {{ $view_property->view_weekly_price ? 'checked=""' : ''}} name="view_weekly_price">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                        <span class="input-group-text">£</span>
                                                    </div>
                                                    {!! Form::text('weekly_price', null, array('class' => 'form-control price', ' placeholder' => '0.00')) !!}
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info">
                                                                <input type="checkbox" {{ $view_property->view_max_tenancy_length ? 'checked=""' : ''}} name="view_max_tenancy_length" data-toggle="kt-tooltip" title="Show On Public">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    {!! Form::text('max_tenancy_length', null, array('class' => 'form-control tenancy-month', ' placeholder' => '0.00')) !!}
                                                    <span class="input-group-text">months</span>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" {{ $view_property->view_deposit ? 'checked=""' : ''}}  name="view_deposit">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" {{ $view_property->view_number_tenant ? 'checked=""' : ''}} name="view_number_tenant">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    {!! Form::text('number_tenant', null, array('class' => 'form-control tenants-number')) !!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="input-group date">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" {{ $view_property->view_show_date ? 'checked=""' : ''}} name="view_show_date">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    {!! Form::text('show_date', null, array('class' => 'form-control',  'placeholder' => 'Select date', 'id' => 'kt_datepicker_6')) !!}
                                                    <div class="input-group-append">
														<span class="input-group-text">
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        @if($property->property_status == 'rent')
                                            <div class="form-group row">
                                                <label class="col-3 kt-font-bolder">Bills Included
                                                    <label data-toggle="kt-tooltip" title="Show On Public">
                                                        <input type="checkbox" {{ $view_property->view_bill ? 'checked=""' : ''}} name="view_bill">
                                                        <span></span>
                                                    </label>
                                                </label>
                                                <div class="col-3">
                                                    <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                        <label>
                                                            <input type="checkbox"  name="bill" {{ $property->bill ? 'checked=""' : ''}}>
                                                            <span></span>
                                                        </label>
                                                    </span>
                                                </div>
                                                <label class="col-3 kt-font-bolder">Parking
                                                    <label data-toggle="kt-tooltip" title="Show On Public">
                                                        <input type="checkbox" {{ $view_property->view_parking ? 'checked=""' : ''}} name=view_parking>
                                                        <span></span>
                                                    </label>
                                                </label>
                                                <div class="col-3">
                                                    <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                        <label>
                                                            <input type="checkbox" name="parking" {{ $property->parking ? 'checked=""' : ''}} >
                                                            <span></span>
                                                        </label>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-3 kt-font-bolder">Garden Access
                                                    <label data-toggle="kt-tooltip" title="Show On Public">
                                                        <input type="checkbox" {{ $view_property->view_garden ? 'checked=""' : ''}} name="view_garden"> 
                                                        <span></span>
                                                    </label>
                                                </label>
                                                <div class="col-3">
                                                    <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                        <label>
                                                            <input type="checkbox" name="garden" {{ $property->garden ? 'checked=""' : ''}}>
                                                            <span></span>
                                                        </label>
                                                    </span>
                                                </div>
                                                <label class="col-3 kt-font-bolder">Fireplace
                                                    <label data-toggle="kt-tooltip" title="Show On Public">
                                                        <input type="checkbox" {{ $view_property->view_fireplace ? 'checked=""' : ''}} name="view_fireplace">
                                                        <span></span>
                                                    </label>
                                                </label>
                                                <div class="col-3">
                                                    <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                        <label>
                                                            <input type="checkbox" name="fireplace" {{ $property->fireplace ? 'checked=""' : ''}}>
                                                            <span></span>
                                                        </label>
                                                    </span>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-12 col-md-6">
                                                <div class="row">
                                                    <label class="col-sm-6 kt-font-bolder">{{ $item }}
                                                        <label data-toggle="kt-tooltip" title="Show On Public">
                                                            <input type="checkbox" {{ $view_property['view_'.$i] ? 'checked=""' : ''}} name="view_{{$i}}">
                                                            <span></span>
                                                        </label>
                                                    </label>
                                                    <div class="col-sm-6">
                                                        <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                            <label>
                                                                <input type="checkbox" name="{{$i}}"  {{ $property[$i] ? 'checked=""' : ''}}>
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="form-group  row">
                                                ...
                                                <div data-repeater-list="" class="col-lg-5">
                                                    ...
                                                    <div data-repeater-item class="kt-margin-b-10">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name='extra_features' placeholder="Feature Detail" value="{{ $item }}">
                                                            <div class="input-group-append">
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-3 kt-font-bolder">Student Allowed
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox" {{ $view_property->view_student_allowed ? 'checked=""' : ''}} name="view_student_allowed">
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                                <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                    <label>
                                                        <input type="checkbox"  name="student_allowed" {{ $property->student_allowed ? 'checked=""' : ''}}>
                                                        <span></span>
                                                    </label>
                                                </span>
                                            </div>
                                            <label class="col-3 kt-font-bolder">Pets Allowed
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox" {{ $view_property->view_pets_allowed ? 'checked=""' : ''}}  name="view_pets_allowed">
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                                <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                    <label>
                                                        <input type="checkbox" name="pets_allowed"  {{ $property->pets_allowed ? 'checked=""' : ''}}>
                                                        <span></span>
                                                    </label>
                                                </span>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-3 kt-font-bolder">Families Allowed
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox"  {{ $view_property->view_families_allowed ? 'checked=""' : ''}} name="view_families_allowed">
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                                <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                    <label>
                                                        <input type="checkbox" name="families_allowed"  {{ $property->families_allowed ? 'checked=""' : ''}}>
                                                        <span></span>
                                                    </label>
                                                </span>
                                            </div>
                                            <label class="col-3 kt-font-bolder">Smokers Allowed
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox" {{ $view_property->view_smokers_allowed ? 'checked=""' : ''}} name="view_smokers_allowed">
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                                <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                    <label>
                                                        <input type="checkbox" name="smokers_allowed" {{ $property->smokers_allowed ? 'checked=""' : ''}}>
                                                        <span></span>
                                                    </label>
                                                </span>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-3 kt-font-bolder">DSS Income Accepted
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox" {{ $view_property->view_DSS_income_accepted ? 'checked=""' : ''}} name="view_DSS_income_accepted">
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                                <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                    <label>
                                                        <input type="checkbox" name="DSS_income_accepted" {{ $property->DSS_income_accepted ? 'checked=""' : ''}}>
                                                        <span></span>
                                                    </label>
                                                </span>
                                            </div>
                                            <label class="col-3 kt-font-bolder">Students Only
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox" {{ $view_property->view_student_only ? 'checked=""' : ''}} name="view_student_only">
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                                <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                    <label>
                                                        <input type="checkbox" name="student_only" {{ $property->student_only ? 'checked=""' : ''}}>
                                                        <span></span>
                                                    </label>
                                                </span>
                                            </div>
                                        ...
                                        <div class="pt-1">
                                            <div class="row" id="imageupload">
                                                @for ($i=0; $i < 20; $i++)
                                                    ...
                                                    <div id="cont{{$i}}" class="col-sm-3 sort">
                                                        <div class="thumbnail" style="height:230px;overflow: hidden;padding:3px;" {{(($is_image[$i])?'style="display:none"':'style="display:block"')}} >
                                                            <div id="imageEmpty{{$i}}" align="center" class="empty_image">
                                                                <div class="fa fa-image" style="width: 100px;height: 100px;font-size: 90px;padding-top: 50px;color: #DFDBD1"></div>
                                                            </div>
                                                            @include('admin.properties.upload',[
                                                                'is_image'=>$is_image[$i],
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">  
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio">
                                                        <input type="radio" name="current_user" {{ $property->current_user == 0 ? 'checked=""' : ''}} value="0" onclick="handleAgentUser(0)"> No
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio">
                                                        <input type="radio" name="current_user" {{ $property->current_user ? 'checked=""' : ''}} value="1" onclick="handleAgentUser(1)"> Yes
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row hide" >
                                            ...
                                            <div class="col-9">
                                                <select class="form-control" id="user_id" name="user_id"  >
                                                    ...
                                                    <option {{ $property->user_id == $item['id'] ? 'selected=""' : ''}} value="{{$item['id']}}">{{ $item['name'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="kt-section">
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            <label class="kt-font-bolder col-3 col-form-label">* Is {{ config('app.name')}} Owner?</label>
                                            <div class="col-9">  
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio">
                                                        <input type="radio" name="is_owner" value="0" {{ $property->is_owner == 0 ? 'checked=""' : ''}} onclick="handleCustomer(0)"> No
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio">
                                                        <input type="radio" name="is_owner" value="1" {{ $property->is_owner ? 'checked=""' : ''}} onclick="handleCustomer(1)"> Yes
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-9">
                                                <div class="input-group">
                                                    <select class="form-control" name="customer_id"  >
                                                        ...
                                                        <option value="{{$item['id']}}" {{ $property->customer_id == $item['id'] ? 'selected=""' : ''}} >{{ $item['name'] }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="input-group-append">
                                        ...
                                        <div class="form-group row hide" >
                                            ...
                                            <div class="col-9">
                                                <textarea name="note" class="form-control" rows="5">{{ $property->note}}</textarea>
                                                <span class="form-text text-muted">This field is not show for public.</span>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $(function(){
            ...
            handleAdvertType('{{ $property->advert_type }}');
            handleCustomer('{{ $property->is_owner }}');
        });
        function handleAdvertType(type) {
            var property_type = $('select[name=property_type]');
            var advert_name = $('.advert-name');
            if(type === 'room_only') {
                var data = '<option value="">Please Select</option>@foreach(config('home.property_type_for_room') as $i => $item) <option value="{{ $i }}">{{ $item }}</option> @endforeach';
                ...
                @if($property->property_status == 'buy')
                    data = '<option value="">Please Select</option>@foreach(config('home.property_type_for_sale') as $i => $item) <option value="{{ $i }}">{{ $item }}</option> @endforeach';
                @else
                    data = '<option value="">Please Select</option>@foreach(config('home.property_type') as $i => $item) <option value="{{ $i }}">{{ $item }}</option> @endforeach';
                @endif
                property_type.html(data);
        ...
        function handleAgentUser(type) {
            if(type === 1) {
                $('select[name="user_id"]').val('{{auth()->user()->id}}');
            } else {
        ...
        maxfiles = '{{ ($imageCount > 0?20-$imageCount:20) }}';
    ...
    <script title="editor">
        ...
        function handleMap(){
            ...
            if(postcode != "" && address != "" && city != ""){
                $.ajax({
                    ...
                    type:"POST",
                    url: "{{ url('dashboard/properties/map') }}",
        ...
        function handleAddCustomer (){
            ...
            $.ajax({
                ...
                type:"POST",
                url: "{{ url('dashboard/customers/quick-add-customer') }}",
                ...
                cache:false,success:function(html)
                {
                    ...
                    $('#confirm_customer').click(async function() {
                        ...
                        if($("#kt_form_1").valid()) {
                            ...
                            console.log(json);
                            const response = await fetch("{{ url('dashboard/customers/store-quick-add-customer') }}", {
                                'method': 'POST',
                                headers: {
        ...
        <script src="{{ asset('/js/admin/property_form.js') }}" type="text/javascript"></script>
