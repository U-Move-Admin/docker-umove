<x-admin-layout>
    <x-slot name="header">{{ __('Add Property') }} </x-slot>
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">Add Property <small>try to scroll the page</small></h3>
                    </div>
                ...
                <div class="kt-portlet__body">
                    {!! Form::open(array('route' => 'properties.store','method'=>'POST', 'id' => 'property_form', 'enctype'=>'multipart/form-data')) !!}    
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input name="view_postcode" type="checkbox" checked="">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    <input name="postcode" class="form-control" type="text" value="">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <div class="kt-radio-inline">
                                                    ...
                                                    <label class="kt-radio">
                                                        <input type="radio" name="advert_type" value="{{$i}}" onclick="handleAdvertType('{{$i}}')"> {{$item}}
                                                        <span></span>
                                                    </label>
                                                    @endforeach
                                                    @else
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" checked="" name="view_address">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    <input name="address" class="form-control" type="text" placeholder="Flat 301 or 10 Downing St">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" checked="" name="view_property_type">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" checked="" name="view_address2">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    <input name="address2" class="form-control" type="text" placeholder="eg. 10 Downing St or Westminster">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group row">
                                                    <div class="col-6">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text">
                                                                    <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                        <input type="checkbox" checked="" name="view_bedroom">
                                                                        <span></span>
                                                                    </label>
                                                                </span>
                                                            </div>
                                                            <input name="bedroom" class="form-control bedroom" type="text" value="">
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text">
                                                                    <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                        <input type="checkbox" checked="" name="view_bathroom">
                                                                        <span></span>
                                                                    </label>
                                                                </span>
                                                            </div>
                                                            <input name="bathroom" class="form-control bathroom" type="text" value="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" checked="" name="view_address3">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    <input name="address3" class="form-control" type="text">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" checked="" name="view_furnished">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" checked="" name="view_city">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    <input name="city" class="form-control" type="text" placeholder="eg. London">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" checked="" name="view_location">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    <input name="location" class="form-control" readonly type="text" placeholder="Please choose location of the property on Map">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" checked="" name="view_price">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                        <span class="input-group-text">£</span>
                                                    </div>
                                                    <input name="price" class="form-control price" type="text" value="" placeholder="0.00">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info">
                                                                <input type="checkbox" checked="" name="view_min_tenancy_length" data-toggle="kt-tooltip" title="Show On Public">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                        
                                                    </div>
                                                    <input class="form-control tenancy-month" name="min_tenancy_length" type="text" value="" placeholder="0.00">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" checked="" name="view_weekly_price">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                        <span class="input-group-text">£</span>
                                                    </div>
                                                    <input name="weekly_price" class="form-control price" type="text" placeholder="0.00">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info">
                                                                <input type="checkbox" checked="" name="view_max_tenancy_length" data-toggle="kt-tooltip" title="Show On Public">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    <input class="form-control tenancy-month" name="max_tenancy_length" type="text" value="" placeholder="0.00">
                                                    <span class="input-group-text">months</span>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" checked="" name="view_deposit">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    <input name="deposit" class="form-control" type="text" value="">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" checked="" name="view_number_tenant">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    <input name="number_tenant" class="form-control tenants-number" type="text" value="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="input-group date">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--info" data-toggle="kt-tooltip" title="Show On Public">
                                                                <input type="checkbox" checked="" name="view_show_date">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                    <input name="show_date" type="text" class="form-control" readonly="" placeholder="Select date" id="kt_datepicker_6">
													<div class="input-group-append">
														<span class="input-group-text">
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-3 kt-font-bolder">Bills Included
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox" checked="" name="view_bill">
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                            ...
                                            <label class="col-3 kt-font-bolder">Parking
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox" checked="" name=view_parking>
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-3 kt-font-bolder">Garden Access
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox" checked="" name="view_garden"> 
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                            ...
                                            <label class="col-3 kt-font-bolder">Fireplace
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox" checked="" name="view_fireplace">
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-12 col-md-6">
                                                <div class="row">
                                                    <div class="col-sm-6 kt-font-bolder">{{ $item }}
                                                        <label data-toggle="kt-tooltip" title="Show On Public">
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-3 kt-font-bolder">Student Allowed
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox" checked="" name="view_student_allowed">
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                                <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                    <label>
                                                        <input type="checkbox"  name="student_allowed" checked="checked">
                                                        <span></span>
                                                    </label>
                                                </span>
                                            </div>
                                            <label class="col-3 kt-font-bolder">Pets Allowed
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox" checked="" name="view_pets_allowed">
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                                <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                    <label>
                                                        <input type="checkbox" name="pets_allowed" checked="checked">
                                                        <span></span>
                                                    </label>
                                                </span>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-3 kt-font-bolder">Families Allowed
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox" checked="" name="view_families_allowed">
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                                <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                    <label>
                                                        <input type="checkbox" checked="checked" name="families_allowed">
                                                        <span></span>
                                                    </label>
                                                </span>
                                            </div>
                                            <label class="col-3 kt-font-bolder">Smokers Allowed
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox"  checked="" name="view_smokers_allowed">
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                                <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                    <label>
                                                        <input type="checkbox" name="smokers_allowed" checked="checked">
                                                        <span></span>
                                                    </label>
                                                </span>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-3 kt-font-bolder">DSS Income Accepted
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox" checked="" name="view_DSS_income_accepted">
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                                <span class="kt-switch kt-switch--icon kt-switch--outline">
                                                    <label>
                                                        <input type="checkbox" checked="checked" name="DSS_income_accepted">
                                                        <span></span>
                                                    </label>
                                                </span>
                                            </div>
                                            <label class="col-3 kt-font-bolder">Students Only
                                                <label data-toggle="kt-tooltip" title="Show On Public">
                                                    <input type="checkbox" checked="checked" name="view_student_only">
                                                    <span></span>
                                                </label>
                                            </label>
                                            <div class="col-3">
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">  
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio">
                                                        <input type="radio" name="current_user" value="0" onclick="handleAgentUser(0)"> No
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio">
                                                        <input type="radio" name="current_user" value="1" onclick="handleAgentUser(1)"> Yes
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row hide" id="agent" >
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">  
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio">
                                                        <input type="radio" name="is_owner" value="0" onclick="handleCustomer(0)"> No
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio">
                                                        <input type="radio" name="is_owner" value="1" onclick="handleCustomer(1)"> Yes
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
        ...
        <div class="qq-uploader-selector qq-uploader" qq-drop-area-text="Drop images here">
            ...
            <dialog class="qq-confirm-dialog-selector">
                ...
                <div class="qq-dialog-buttons">
                    ...
                    <button type="button" class="qq-ok-button-selector">Yse</button>
                </div>
            </dialog>
    ...
    <script>
        ...
        @if($property_status == 'buy')
            var property_type = $('select[name=property_type]');
            var data = '<option value="">Please Select</option>@foreach(config('home.property_type_for_sale') as $i => $item) <option value="{{ $i }}">{{ $item }}</option> @endforeach';
        ...
        function handleAdvertType(type) {
            ...
            if(type === 'room_only') {
                ...
                var data = '<option value="">Please Select</option>@foreach(config('home.property_type') as $i => $item) <option value="{{ $i }}">{{ $item }}</option> @endforeach';
                property_type.html(data);
